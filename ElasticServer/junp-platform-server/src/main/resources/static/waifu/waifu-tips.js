...
function showMessage(a, c, e) {
    ...
    e && sessionStorage.setItem("waifu-text", a),
        $(".waifu-tips").stop(),
        $(".waifu-tips").html(a).fadeTo(200, 1),
    void 0 === c && (c = 5E3),
        hideMessage(c))
}
...
function initModel(a, c) {
    ...
    "auto" == live2d_settings.homePageUrl ? (window.location.protocol,
        window.location.hostname) : live2d_settings.homePageUrl;
    ...
    live2d_settings.modelStorage && null != a || (a = live2d_settings.modelId,
        c = live2d_settings.modelTexturesId);
    loadModel(a, c)
}
function loadModel(a) {
    var c = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0;
    live2d_settings.modelStorage ? (localStorage.setItem("modelId", a),
        localStorage.setItem("modelTexturesId", c)) : (sessionStorage.setItem("modelId", a),
...
live2d_settings.modelAPI = "model/";
